...
public abstract class TestWatcher implements TestRule {
    ...
    private void skippedQuietly(
            ...
            List<Throwable> errors) {
        try {
            if (e instanceof AssumptionViolatedExceptionJr) {
                skipped((AssumptionViolatedExceptionJr) e, description);
            } else {
     ...
     */
    protected void skipped(AssumptionViolatedExceptionJr e, Description description) {
     ...
     * Invoked when a test is skipped due to a failed assumption.
     *
     * @deprecated use {@link #skipped(AssumptionViolatedExceptionJr, Description)}
     */
    @Deprecated
